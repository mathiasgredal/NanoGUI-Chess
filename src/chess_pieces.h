...
public:
    ...
    virtual void RegisterMove(Move mv) { initialMove = false; };
...
public:
    ...
    Chess_Piece* Clone() override { return new Rook(*this); }
...
public:
    ...
    Chess_Piece* Clone() override { return new King(*this); }
...
public:
    ...
    Chess_Piece* Clone() override { return new Queen(*this); }
...
public:
    ...
    Chess_Piece* Clone() override { return new Bishop(*this); }
...
public:
    ...
    Chess_Piece* Clone() override { return new Knight(*this); }
...
public:
    ...
    Chess_Piece* Clone() override { return new Pawn(*this); }
...
public:
    ...
    Chess_Piece* Clone() override { return new Empty(*this); }

    vector<Move> ValidMoves(Board& /*board*/) override { return {}; }
};
